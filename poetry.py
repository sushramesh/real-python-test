...
def make_poem():
	...
	if vowels.find(adj_3[0][0]) != -1:
		print "An {adjective1} {noun1}\n".format(adjective1=adj_3[0], noun1 = noun_3[0])
	else:
		print "A {adjective1} {noun1}\n".format(adjective1=adj_3[0], noun1 = noun_3[0])
	...
	for i in range(0,5):
		...
		if vowels.find(adj_3[2][0]) != -1:
			print "the {noun2} {verb3} {preposition2} an {adjective3} {noun3}"\
			.format(noun2=noun_3[1], verb3=verb_3[2],preposition2=prepo_3[1], adjective3=adj_3[2], noun3=noun_3[2])
		else:
			print "the {noun2} {verb3} {preposition2} an {adjective3} {noun3}"\
			.format(noun2=noun_3[1], verb3=verb_3[2],preposition2=prepo_3[1], adjective3=adj_3[2], noun3=noun_3[2])
